...
// block models
new const gszBlockModelDefault[] = "models/NyBM/igz_trampoline.mdl";
new const gszBlockModelPlatform[] = "models/NyBM/igz_platformv2.mdl";
new const gszBlockModelBhop[] = "models/NyBM/igz_bhopv5.mdl";
new const gszBlockModelDamage[] = "models/NyBM/igz_damage.mdl";
new const gszBlockModelHealer[] = "models/NyBM/igz_health.mdl";
new const gszBlockModelInvincibility[] = "models/NyBM/igz_invincibility.mdl";
new const gszBlockModelStealth[] = "models/NyBM/igz_stealth.mdl";
new const gszBlockModelSpeedBoost[] = "models/NyBM/igz_speedboost.mdl";
new const gszBlockModelNoFallDamage[] = "models/NyBM/igz_nofalldamage.mdl";
new const gszBlockModelIce[] = "models/NyBM/igz_ice.mdl";
new const gszBlockModelDeath[] = "models/NyBM/igz_death.mdl";
new const gszBlockModelHE[] = "models/NyBM/igz_grenade.mdl";
new const gszBlockModelCamouflage[] = "models/NyBM/igz_camouflage.mdl";
new const gszBlockModelLowGravity[] = "models/NyBM/igz_gravity.mdl";
new const gszBlockModelFire[] = "models/NyBM/igz_fire.mdl";
new const gszBlockModelRandom[] = "models/NyBM/igz_random.mdl";
new const gszBlockModelSlap[] = "models/NyBM/igz_slapv2.mdl";
new const gszBlockModelHoney[] = "models/NyBM/igz_honey.mdl";
new const gszBlockModelBarrierCT[] = "models/NyBM/igz_ct_barrier.mdl";
new const gszBlockModelBarrierT[] = "models/NyBM/igz_t_barrier.mdl";
new const gszBlockModelBootsOfSpeed[] = "models/NyBM/igz_boostofspeedv2.mdl";
new const gszBlockModelGlass[] = "models/blockmaker/bm_block_glass.mdl";
new const gszBlockModelBhopNoSlow[] = "models/blockmaker/bm_block_noslow.mdl";
new const gszBlockModelDuck[] = "models/NyBM/igz_duck.mdl";
new const gszBlockModelAss[] = "models/NyBM/igz_trampoline.mdl";
new const gszBlockModelSalto[] = "models/NyBM/igz_trampoline.mdl";
new const gszBlockModelFrost[] = "models/NyBM/igz_frostblock.mdl";
new const gszBlockModelFlash[] = "models/NyBM/igz_flashnade.mdl";
new const gszBlockModelDelayed[] = "models/NyBM/igz_delay_bhop.mdl";
new const gszBlockModelMoney[] = "models/NyBM/igz_money.mdl";
new const gszBlockModelDeagle[] = "models/NyBM/igz_deagle.mdl";
new const gszBlockModelAwp[] = "models/NyBM/igz_gun_awp.mdl";
new const gszBlockModelGravity[] = "models/NyBM/igz_superman.mdl";
...
createMenus()
{
	...
	add(gszMainMenu, size, "\rShadezz Blockmaker^n");
	add(gszMainMenu, size, "\r1. \yBlocks here^n");
	add(gszMainMenu, size, "\r2. \yTeleports Here^n");
	add(gszMainMenu, size, "\r3. \yTimers Here^n");
	add(gszMainMenu, size, "\r4. \yMeasuring Tool^n");
	add(gszMainMenu, size, "\r5. \yLJ Menu^n^n");
