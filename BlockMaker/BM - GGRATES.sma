...
// block models
new const gszBlockModelDefault[] = "models/ggrates/gg_tramp.mdl";
new const gszBlockModelPlatform[] = "models/ggrates/gg_platform.mdl";
new const gszBlockModelBhop[] = "models/ggrates/ggrates_bhop.mdl";
new const gszBlockModelDamage[] = "models/iGz_HnS_Blockmaker/igz_damage.mdl";
new const gszBlockModelHealer[] = "models/ggrates/gg_health1.mdl";
...
new const gszBlockModelSpeedBoost[] = "models/ggrates/gg_speedboost.mdl";
new const gszBlockModelNoFallDamage[] = "models/ggrates/gg_nofall.mdl";
new const gszBlockModelIce[] = "models/ggrates/gg_ice.mdl";
new const gszBlockModelDeath[] = "models/ggrates/death_gg.mdl";
...
new const gszBlockModelHoney[] = "models/ggrates/gg_honey.mdl";
...
new const gszBlockModelGlass[] = "models/ggrates/gg_platform.mdl";
...
new const gszBlockModelTrampolineLow[] = "models/ggrates/gg_tramp.mdl";
new const gszBlockModelTrampolineMid[] = "models/ggrates/gg_tramp.mdl";
new const gszBlockModelTrampolineHigh[] = "models/ggrates/gg_tramp.mdl";
...
public plugin_precache()
{
	...
	setupBlockRendering(BM_GLASS, TRANSWHITE, 255, 255, 255, 50);
...
createMenus()
{
	...
	add(gszMainMenu, size, "\y[ggRATES] Block Maker Main Menu^n^n");
	...
	add(gszBlockMenu, size, "\y[ggRATES] Block Menu^n^n");
	...
	add(gszTeleportMenu, size, "\y[ggRATES] Teleporter Menu^n^n");
	...
	add(gszOptionsMenu, size, "\y[ggRATES] Options Menu^n^n");
...
public Flash(id)
{
    ...
    write_short(seconds_to_screenfade_units(3));
    write_short(seconds_to_screenfade_units(3));
    write_short(1<<12);
    write_byte(255);
    write_byte(0);
