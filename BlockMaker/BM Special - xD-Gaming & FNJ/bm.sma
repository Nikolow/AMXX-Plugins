...
new const g_model_awp[] =			"models/xD-GaminG_2/Blocks/Normal/awp.mdl";
new const g_model_usp[] =			"models/xD-GaminG_2/Blocks/Normal/awp.mdl";
...
new bool:g_deagle_used[32];
new bool:g_awp_used[32];
new bool:g_usp_used[32];
...
ActionDeagle(id)
{
    if (is_user_alive(id) && !g_deagle_used[id] && get_user_team(id) == 1)
        {
...
ActionAwp(id)
{
    if (is_user_alive(id) && !g_awp_used[id] && get_user_team(id) == 1)
        {
...
ActionUsp(id)
{
    if (is_user_alive(id) && !g_usp_used[id] && get_user_team(id) == 1)
        {
        give_item(id, "weapon_usp");
        cs_set_weapon_ammo(find_ent_by_owner(2, "weapon_usp", id), 2);
        g_usp_used[id] = true;
        new uspname[42];
        get_user_name(id, uspname, 32);
        set_hudmessage(255, 255, 255, -1.0, -1.0, 0, 6.0, 4.0);
        show_hudmessage(0, "Be careful CT! %s has a USP!", uspname);
    }
}
