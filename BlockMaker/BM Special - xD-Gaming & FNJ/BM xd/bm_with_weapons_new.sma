...
#define PLUGIN_NAME				"xD Gaming2 Block Maker"
#define PLUGIN_VERSION				"4.2"
#define PLUGIN_AUTHOR				"Advanced"
#define PLUGIN_PREFIX				"xD"
...
new const g_model_platform[] =			"models/xD-GaminG_2/Blocks/Normal/platform.mdl";
new const g_model_bunnyhop[] =			"models/xD-GaminG_2/Blocks/Normal/bhop.mdl";
new const g_model_damage[] =			"models/xD-GaminG_2/Blocks/Normal/damage.mdl";
new const g_model_healer[] =			"models/xD-GaminG_2/Blocks/Normal/healer.mdl";
new const g_model_no_fall_damage[] =		"models/xD-GaminG_2/Blocks/Normal/fall.mdl";
new const g_model_ice[] =			"models/xD-GaminG_2/Blocks/Normal/ice.mdl";
new const g_model_trampoline[] =			"models/xD-GaminG_2/Blocks/Normal/tram.mdl";
new const g_model_speed_boost[] =		"models/xD-GaminG_2/Blocks/Normal/boost.mdl";
new const g_model_death[] =			"models/xD-GaminG_2/Blocks/Normal/death.mdl";
new const g_model_low_gravity[] =		"models/xD-GaminG_2/Blocks/Normal/platform.mdl";
new const g_model_slap[] =			"models/xD-GaminG_2/Blocks/Normal/slap.mdl";
new const g_model_honey[] =			"models/xD-GaminG_2/Blocks/Normal/honey.mdl";
new const g_model_ct_barrier[] =			"models/xD-GaminG_2/Blocks/Normal/barrier_ct.mdl";
new const g_model_t_barrier[] =			"models/xD-GaminG_2/Blocks/Normal/t_barrier.mdl";
new const g_model_glass[] =			"models/xD-GaminG_2/Blocks/Normal/glass.mdl";
new const g_model_no_slow_down_bunnyhop[] =	"models/xD-GaminG_2/Blocks/Normal/nsd.mdl";
new const g_model_delayed_bunnyhop[] =		"models/xD-GaminG_2/Blocks/Normal/del.mdl";
new const g_model_invincibility[] =		"models/xD-GaminG_2/Blocks/Normal/invis.mdl";
new const g_model_stealth[] =			"models/xD-GaminG_2/Blocks/Normal/steal.mdl";
new const g_model_boots_of_speed[] =		"models/xD-GaminG_2/Blocks/Normal/speed.mdl";
new const g_model_xpblock[] =			"models/xD-GaminG_2/Blocks/Normal/xp.mdl";
new const g_model_deagle[] =			"models/xD-GaminG_2/Blocks/Normal/deagle.mdl";

new const g_sprite_light[] =			"sprites/xD-GaminG_2/Light.spr";

new const g_sprite_teleport_start[] =		"sprites/xD-GaminG_2/Teleport_Start.spr";
new const g_sprite_teleport_destination[] =	"sprites/xD-GaminG_2/Teleport_End.spr";

new const g_sound_invincibility[] =		"warcraft3/divineshield.wav";
new const g_sound_stealth[] =			"warcraft3/xD-GaminG_2_Stealth.wav";
new const g_sound_boots_of_speed[] =		"warcraft3/xD-GaminG_2_BootsOfSpeed.wav";
...
public FwdCmdStart(id, handle)
{
	...
	&& !g_has_hud_text[id] )
	{
		...
		if ( IsBlock(ent) )
		{
			...
			set_hudmessage(random(255), random(255), random(255), 0.01, 0.18, 0, 0.0, 1.0, 0.25, 0.25, 2);
...
{
	new Float:gametime = get_gametime();
	if ( !( gametime >= g_deagle_next_use[id] ) && get_user_team(id) == 1 && is_user_alive(id) )
	{
		if ( !g_has_hud_text[id] )
		{
			set_hudmessage(random(255), random(255), random(255), 0.01, 0.18, 0, 0.0, 1.0, 0.25, 0.25, 2);
			show_hudmessage(id, "%s %s^nDeagle Block^nNext Use: 1 round", PLUGIN_PREFIX, PLUGIN_VERSION );
		}
	...
	switch( get_user_team(id) ) 
	{
		case 2:
		{
			...
			{
				set_hudmessage(random(255), random(255), random(255), 0.01, 0.18, 0, 0.0, 1.0, 0.25, 0.25, 2);
				show_hudmessage(id, "%s %s^nDeagle Block^nOnly Terrorists Can Use This Block", PLUGIN_PREFIX, PLUGIN_VERSION );
			}
		...
		default:
		{
			if( user_has_weapon(id, CSW_DEAGLE) && get_user_team(id) == 1 )
			{
				cs_set_user_bpammo(id, CSW_DEAGLE, (cs_get_user_bpammo(id, CSW_DEAGLE) + 0));
			}
			else
			{
			...
			g_block_status[id] = true;
			g_deagle_next_use[id] = gametime + str_to_float(property);
