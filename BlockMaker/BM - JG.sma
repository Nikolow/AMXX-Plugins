...
public plugin_init()
{
	...
	g_cvar_he_grenade_cooldown =	register_cvar("bm_hegrenadecooldown", "999");
	g_cvar_flashbang_cooldown =	register_cvar("bm_flashbangcooldown", "999");
	g_cvar_smoke_grenade_cooldown =	register_cvar("bm_smokegrenadecooldown", "999");
	g_cvar_suffer_cooldown =        register_cvar("bm_suffercooldown", "999");
...
CreateMenus()
{
	...
	add(g_main_menu, size, "\r[%s] \y%s \rv%s^n^n\yLoaded Blocks: \r%d^n^n");
	...
	add(g_block_menu, size, "\r[%s] \yBlock Menu^n\yLoaded Blocks: \r%d^n^n");
	...
	add(g_teleport_menu, size, "\r[%s] \yTeleport Menu^n\yLoaded Teleports: \r%d^n^n");
	...
	add(g_light_menu, size, "\r[%s] \yLight Creator^n\yLoaded Lights: \r%d^n^n");
	...
	add(g_light_properties_menu, size, "\r[%s] \yLight Settings^n^n^n");
	...
	add(g_commands_menu, size, "\r[%s] \ynot this one^n^n");
	...
	add(g_change_team_menu, size, "\r[%s] \yAdmin Menu^n^n\r");
...
{
	new GrenadeMenu = menu_create("\r[jG] \yPick A Grenade!", "ShowGrenadeMenu");
...
ChangeBlockSize(id)
{
	switch ( g_selected_block_size[id] )
	{
		...
		case LARGE:	g_selected_block_size[id] = SMALL;
	}
}
