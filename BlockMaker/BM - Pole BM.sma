...
#define VERSION "0.5"
#define AUTHOR "koleos edited by Teh Newb"
...
// block models
new const gszBlockModelDefault[] = "models/blockmaker/new/bm_block_default.mdl";
new const gszBlockModelPlatform[] = "models/blockmaker/w2k/w2k_platform.mdl";
new const gszBlockModelBhop[] = "models/blockmaker/w2k/w2k_bhop2.mdl";
new const gszBlockModelDamage[] = "models/blockmaker/new/bm_block_damage.mdl";
new const gszBlockModelHealer[] = "models/blockmaker/w2k/w2k_healer.mdl";
new const gszBlockModelInvincibility[] = "models/blockmaker/new/bm_block_invincibility.mdl";
new const gszBlockModelStealth[] = "models/blockmaker/new/bm_block_stealth.mdl";
new const gszBlockModelSpeedBoost[] = "models/blockmaker/new/bm_block_speedboost.mdl";
new const gszBlockModelNoFallDamage[] = "models/blockmaker/new/bm_block_nofalldamage.mdl";
new const gszBlockModelIce[] = "models/blockmaker/new/bm_block_ice.mdl";
new const gszBlockModelDeath[] = "models/blockmaker/w2k/w2k_death.mdl";
new const gszBlockModelCamouflage[] = "models/blockmaker/new/bm_block_camouflage.mdl";
new const gszBlockModelLowGravity[] = "models/blockmaker/new/bm_block_lowgravity.mdl";
new const gszBlockModelFire[] = "models/blockmaker/new/bm_block_fire.mdl";
new const gszBlockModelRandom[] = "models/blockmaker/new/bm_block_random.mdl";
new const gszBlockModelSlap[] = "models/blockmaker/new/bm_block_slap.mdl";
new const gszBlockModelHoney[] = "models/blockmaker/new/bm_block_honey.mdl";
new const gszBlockModelBarrierCT[] = "models/blockmaker/new/bm_block_barrier_ct.mdl";
new const gszBlockModelBarrierT[] = "models/blockmaker/new/bm_block_barrier_t.mdl";
new const gszBlockModelBootsOfSpeed[] = "models/blockmaker/new/bm_block_bootsofspeed.mdl";
new const gszBlockModelGlass[] = "models/blockmaker/w2k/w2k_glass.mdl";
new const gszBlockModelBhopNoSlow[] = "models/blockmaker/new/bm_block_bhop_noslow.mdl";
new const gszBlockModelDelayedBhop[] = "models/blockmaker/new/bm_block_delayed.mdl";
new const gszBlockModelFade[] = "models/blockmaker/new/bm_block_blind.mdl";
new const gszBlockModelUSP[] = "models/blockmaker/new/bm_block_usp.mdl";
new const gszBlockModelDEagle[] = "models/blockmaker/new/bm_block_deagle.mdl";
new const gszBlockModelHe[] = "models/blockmaker/w2k/w2k_nade.mdl";
new const gszBlockModelSmoke[] = "models/blockmaker/new/bm_block_frost1337.mdl";
new const gszBlockModelFlash[] = "models/blockmaker/new/bm_block_flashbang1337.mdl";
new const gszBlockModelAWP[] = "models/blockmaker/w2k/w2k_awp.mdl";
new const gszBlockModelTrampolineLow[] = "models/blockmaker/w2k/w2k_trampoline.mdl";
new const gszBlockModelTrampolineMid[] = "models/blockmaker/w2k/w2k_trampoline.mdl";
new const gszBlockModelTrampolineHigh[] = "models/blockmaker/w2k/w2k_trampoline.mdl";
new const gszBlockModelLight[] = "models/blockmaker/new/bm_block_light.mdl";
new const gszBlockModelNoFallDamageBhop[] = "models/blockmaker/new/bm_block_nofalldamagebhop.mdl";
...
new const gszBlockNames[gBlockMax][35] =
{
	"Platform",
	"Bunnyhop",
	"Damage",
...
'A', 'B', 'C', 'D', 'I', 'J', 'H', 'E', 'F', 'K', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', '$', '<', '6', '#', 'Y', 'Z', '!', '@', '=', 'G', ')', '(', '4'
...
public plugin_precache()
{
	...
	setupBlockRendering(BM_GLASS, TRANSALPHA, 255, 255, 255, 100);
...
createMenus()
{
	...
	add(gszMainMenu, size, "\w[w2k]\rBlockMaker^n^n");
	add(gszMainMenu, size, "\r1. \yBlock Menu^n");
	add(gszMainMenu, size, "\r2. \yTeleport Menu^n");
	add(gszMainMenu, size, "\r3. \yMeasuring Tool^n^n");
	add(gszMainMenu, size, "\r6. %s\yNoclip: %s^n");
	add(gszMainMenu, size, "\r7. %s\yGodmode: %s^n^n^n");
	add(gszMainMenu, size, "\r9. \yOptions Menu^n");
	add(gszMainMenu, size, "\r0. \wClose");
	gKeysMainMenu = B1 | B2 | B3 | B6 | B7 | B9 | B0;
	
	//create block menu
	size = sizeof(gszBlockMenu);
	add(gszBlockMenu, size, "\w[w2k]\rBlockMaker^n^n");
	add(gszBlockMenu, size, "\r1. \yBlock Type: \w%s^n");
	add(gszBlockMenu, size, "\r2. %s\yCreate Block^n");
	add(gszBlockMenu, size, "\r3. %s\yConvert Block^n");
	add(gszBlockMenu, size, "\r4. %s\yDelete Block^n");
	add(gszBlockMenu, size, "\r5. %s\yRotate Block^n^n");
	add(gszBlockMenu, size, "\r6. %s\yNoclip: %s^n");
	add(gszBlockMenu, size, "\r7. %s\yGodmode: %s^n");
	add(gszBlockMenu, size, "\r8. \yBlock Size: \w%s^n^n");
	add(gszBlockMenu, size, "\r9. \yOptions Menu^n");
	...
	add(gszTeleportMenu, size, "\w[w2k]\rBlockMaker^n^n");
	add(gszTeleportMenu, size, "\r1. %s\yTeleport \wStart^n");
	add(gszTeleportMenu, size, "\r2. %s\yTeleport \wDestination^n");
	add(gszTeleportMenu, size, "\r3. %s\ySwap Teleport \wStart/Destination^n");
	add(gszTeleportMenu, size, "\r4. %s\yDelete Teleport^n");
	add(gszTeleportMenu, size, "\r5. %s\yTeleport Path^n^n");
	add(gszTeleportMenu, size, "\r6. %s\yNoclip: %s^n");
	add(gszTeleportMenu, size, "\r7. %s\yGodmode: %s^n^n^n");
	add(gszTeleportMenu, size, "\r9. \yOptions^n");
	add(gszTeleportMenu, size, "\r0. \wBack");
	gKeysTeleportMenu = B1 | B2 | B3 | B4 | B5 | B6 | B7 | B9 | B0;
		
	//measuring tool menu
	size = sizeof(gszMeasureMenu);
	add(gszMeasureMenu, size, "\w[w2k]\rBlockMaker^n^n");
	add(gszMeasureMenu, size, "\r1. \yBlock 1: \w%s^n");
	add(gszMeasureMenu, size, "\r2. \yBlock 2: \w%s^n");
	add(gszMeasureMenu, size, "\r3. \yPosition 1: \w%.2f, %.2f, %.2f^n");
	add(gszMeasureMenu, size, "\r4. \yPosition 2: \w%.2f, %.2f, %.2f^n^n");
	add(gszMeasureMenu, size, "\r5. %s\yMeasuring Tool: %s^n");
	add(gszMeasureMenu, size, "\r6. %s\yNoclip: %s^n");
	add(gszMeasureMenu, size, "\r7. %s\yGodmode: %s^n^n^n");
	add(gszMeasureMenu, size, "\r9. \yOptions Menu^n");
	add(gszMeasureMenu, size, "\r0. \wBack");
	gKeysMeasureMenu = B1 | B2 | B3 | B4 | B5 | B6 | B7 | B9 | B0;
		
	//create the options menu
	size = sizeof(gszOptionsMenu);
	add(gszOptionsMenu, size, "\w[w2k]\rBlockMaker^n^n");
	add(gszOptionsMenu, size, "\r1. %s\ySnapping: %s^n");
	add(gszOptionsMenu, size, "\r2. %s\ySnapping gap: \w%.1f^n^n");
	add(gszOptionsMenu, size, "\r3. %s\yAdd to group^n");
	add(gszOptionsMenu, size, "\r4. %s\yClear group^n^n");
	add(gszOptionsMenu, size, "\r5. %s\yDelete all blocks^n");
	add(gszOptionsMenu, size, "\r6. %s\yDelete all teleports^n^n");
	add(gszOptionsMenu, size, "\r7. %s\ySave to file^n");
	add(gszOptionsMenu, size, "\r8. %s\yLoad from file^n");
	add(gszOptionsMenu, size, "\r9. \yHelp^n");
	...
	add(gszChoiceMenu, size, "\r2. \rNo^n^n^n^n^n^n^n^n^n^n");
...
{
	if(is_user_alive(id) && !grenade_taken[num][id])
		{
		switch(num)
		{
			case HE: give_item(id, "weapon_hegrenade");
			case SMOKE: give_item(id, "weapon_smokegrenade");
			case FLASH: give_item(id, "weapon_flashbang");
		}
		grenade_taken[num][id] = true;
	}
}
