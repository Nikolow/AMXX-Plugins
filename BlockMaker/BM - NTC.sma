...
#define VERSION "1.0"
#define AUTHOR "No one xD" //cause nTc is gay
...
const TASK_DELAYED = 13000;
const TASK_GRAVITY = 14000;
...
// block models
new const gszBlockModelDefault[] = "models/iGz_HnS_Blockmaker/igz_trampoline.mdl";
new const gszBlockModelPlatform[] = "models/iGz_HnS_Blockmaker/igz_platformv2.mdl";
new const gszBlockModelBhop[] = "models/iGz_HnS_Blockmaker/igz_bhopv5.mdl";
new const gszBlockModelDamage[] = "models/iGz_HnS_Blockmaker/igz_damage.mdl";
new const gszBlockModelHealer[] = "models/iGz_HnS_Blockmaker/igz_health.mdl";
new const gszBlockModelInvincibility[] = "models/iGz_HnS_Blockmaker/igz_invincibility.mdl";
new const gszBlockModelStealth[] = "models/iGz_HnS_Blockmaker/igz_stealth.mdl";
new const gszBlockModelSpeedBoost[] = "models/iGz_HnS_Blockmaker/igz_speedboost.mdl";
new const gszBlockModelNoFallDamage[] = "models/iGz_HnS_Blockmaker/igz_nofalldamage.mdl";
new const gszBlockModelIce[] = "models/iGz_HnS_Blockmaker/igz_ice.mdl";
new const gszBlockModelDeath[] = "models/iGz_HnS_Blockmaker/igz_death.mdl";
new const gszBlockModelHE[] = "models/iGz_HnS_Blockmaker/igz_grenade.mdl";
new const gszBlockModelCamouflage[] = "models/iGz_HnS_Blockmaker/igz_camouflage.mdl";
new const gszBlockModelLowGravity[] = "models/iGz_HnS_Blockmaker/igz_gravity.mdl";
new const gszBlockModelFire[] = "models/iGz_HnS_Blockmaker/igz_fire.mdl";
new const gszBlockModelRandom[] = "models/iGz_HnS_Blockmaker/igz_random.mdl";
new const gszBlockModelSlap[] = "models/iGz_HnS_Blockmaker/igz_slapv2.mdl";
new const gszBlockModelHoney[] = "models/iGz_HnS_Blockmaker/igz_honey.mdl";
new const gszBlockModelBarrierCT[] = "models/iGz_HnS_Blockmaker/igz_ct_barrier.mdl";
new const gszBlockModelBarrierT[] = "models/iGz_HnS_Blockmaker/igz_t_barrier.mdl";
new const gszBlockModelBootsOfSpeed[] = "models/iGz_HnS_Blockmaker/igz_boostofspeedv2.mdl";
new const gszBlockModelGlass[] = "models/iGz_HnS_Blockmaker/bm_block_glass.mdl";
new const gszBlockModelBhopNoSlow[] = "models/iGz_HnS_Blockmaker/igz_bhopv5.mdl";
new const gszBlockModelDuck[] = "models/iGz_HnS_Blockmaker/igz_duck.mdl";
new const gszBlockModelAss[] = "models/iGz_HnS_Blockmaker/igz_trampoline.mdl";
new const gszBlockModelSalto[] = "models/iGz_HnS_Blockmaker/igz_trampoline.mdl";
new const gszBlockModelFrost[] = "models/iGz_HnS_Blockmaker/igz_frostblock.mdl";
new const gszBlockModelFlash[] = "models/iGz_HnS_Blockmaker/igz_flashnade.mdl";
new const gszBlockModelDelayed[] = "models/iGz_HnS_Blockmaker/igz_delay_bhop.mdl";
new const gszBlockModelMoney[] = "models/iGz_HnS_Blockmaker/igz_money.mdl";
new const gszBlockModelDeagle[] = "models/iGz_HnS_Blockmaker/igz_deagle.mdl";
new const gszBlockModelAwp[] = "models/iGz_HnS_Blockmaker/igz_gun_awp.mdl";
new const gszBlockModelGravity[] = "models/iGz_HnS_Blockmaker/igz_superman.mdl";
...
new Float:gfGravityTimeOut[33];
new Float:gfGravityNextUse[33];
new Float:gfSGNextUse[33];
...
{
	'A', 'B', 'C', 'D', 'I', 'J', 'G', 'H', 'E', 'F', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z', '1', '2', '3', '4', '5', '6', '7'
};
...
createMenus()
{
	...
	add(gszMainMenu, size, "\rNtC BlockMaker^n");
	add(gszMainMenu, size, "\r1. \yBlocks here^n");
	add(gszMainMenu, size, "\r2. \yTeleports Here^n");
	...
	add(gszMainMenu, size, "\r0. \yClose Menu");
	gKeysMainMenu = B1 | B2 | B3 | B4 | B5 | B6 | B7 | B9 | B0;
	
	//create block menu
	size = sizeof(gszBlockMenu);
	add(gszBlockMenu, size, "\rBlock Menu^n");
	add(gszBlockMenu, size, "\r1. \yBlock Type: \y%s^n");
	...
	add(gszBlockMenu, size, "\r8. \ySet Scale: \y%s^n^n");
	add(gszBlockMenu, size, "\r9. \yThe Options Menu^n");
	...
	add(gszTeleportMenu, size, "\rTeleporter Menu^n");
	...
	add(gszTimerMenu, size, "\r9. \yThe Options Menu^n");
	add(gszTimerMenu, size, "\r0. \yBack");
	gKeysTimerMenu = B1 | B2 | B3 | B4 | B5 | B6 | B7 | B9 | B0;
	
	//measuring tool menu
	size = sizeof(gszMeasureMenu);
	add(gszMeasureMenu, size, "\rMeasuring Tool Menu^n");
	add(gszMeasureMenu, size, "\r1. \yBlock 1: \y%s^n");
	add(gszMeasureMenu, size, "\r2. \yBlock 2: \y%s^n");
	add(gszMeasureMenu, size, "\r3. \yPosition 1: \y%.2f, %.2f, %.2f^n");
	add(gszMeasureMenu, size, "\r4. \yPosition 2: \y%.2f, %.2f, %.2f^n^n");
	...
	add(gszMeasureMenu, size, "\r9. \yThe Options Menu^n");
	add(gszMeasureMenu, size, "\r0. \yBack");
	gKeysMeasureMenu = B1 | B2 | B3 | B4 | B5 | B6 | B7 | B9 | B0;
	
	//long jump menu
	size = sizeof(gszLongJumpMenu);
	add(gszLongJumpMenu, size, "\rLong Jump Creator Menu^n");
	add(gszLongJumpMenu, size, "\r1. \yDistance +^n");
	add(gszLongJumpMenu, size, "\r2. %sCreate \y%d %sUnit Long Jump Along \y%s^n");
	add(gszLongJumpMenu, size, "\r3. \yDistance -^n");
	...
	add(gszLongJumpMenu, size, "\r8. \yBlock Scale: \y%s^n^n");
	add(gszLongJumpMenu, size, "\r9. \yThe Options Menu^n");
	add(gszLongJumpMenu, size, "\r0. \yBack");
	gKeysLongJumpMenu = B1 | B2 | B3 | B4 | B5 | B6 | B7 | B8 | B9 | B0;
	
	//create the options menu
	size = sizeof(gszOptionsMenu);
	add(gszOptionsMenu, size, "\yOptions Menu^n");
...
{     
	...
	while (!feof(f))
	{
		...
		else if (equal(szType, "HIGH_TRAMPOLINE")) blockType = BM_ASS;
		else if (equal(szType, "LOW_TRAMPOLINE")) blockType = BM_SALTO;
		...
		else if (equal(szType, "GRAVITY")) blockType = BM_GRAVITY;
	...
	if (id > 0 && id <= 32)
	{
		...
		if (is_user_alive(id))
		{
			...
			if (isBlock(ent))
			{
				...
				if (blockType == BM_BHOP || blockType == BM_BARRIER_CT || blockType == BM_BARRIER_T || blockType == BM_BHOP_NOSLOW || blockType == BM_DELAYED)
				{
...
public client_PreThink(id)
{
	...
	if (is_user_connected(id))
	{
		...
		if (is_user_alive(id))
		{
			...
			for (new i = 0; i < 4; ++i)
			{
				...
				if (isBlock(ent))
				{
					...
					switch (blockType)
					{
						...
						case BM_ASS: actionTrampolineAlto(id);
						case BM_SALTO: actionTrampolineBajo(id);
						...
						case BM_GRAVITY: actionGravity(id, false);
					}
				}
			}
			...
			new Float:fTimeleftGravity = gfGravityTimeOut[id] - fTime;
			...
			if (fTimeleftGravity >= 0.0)
			{
				format(szText, sizeof(szText), "Gravity: %.1f^n", fTimeleftGravity);
				add(szTextToShow, sizeof(szTextToShow), szText);
				bShowText = true;
			}
...
resetTimers(id)
{
	...
	gfFrostNextUse[id] = 0.0;
	gfFlashNextUse[id] = 0.0;
	gfMoneyNextUse[id] = 0.0;
	gfDeagleNextUse[id] = 0.0;
	gfAwpNextUse[id] = 0.0;
	gfGravityTimeOut[id] = 0.0;
	gfGravityNextUse[id] = 0.0;
	gfSGNextUse[id] = 0.0;
...
actionRandom(id, ent)
{
	...
	if (fTime >= gfRandomNextUse[id])
	{
		...
		switch (blockType)
		{
			...
			case BM_GRAVITY: actionGravity(id, true);
		}
...
actionGravity(id, bool:OverrideTimer)
{
	new Float:fTime = halflife_time();
...
loadBlocks(id)
{
	...
	if (bAccess)
	{
		...
		if (file_exists(gszNewFile))
		{
			...
			new szData[512];
			new szType[2];
			new sz1[16], sz2[16], sz3[16], sz4[16], sz5[16], sz6[16], sz7[16], szName[32];
			new Float:vVec1[3];
			new Float:vVec2[3];
			new axis;
			new size;
			...
			while (!feof(f))
			{
				szType = "";
				fgets(f, szData, 512);
				parse(szData, szType, 1, sz1, 16, sz2, 16, sz3, 16, sz4, 16, sz5, 16, sz6, 16, sz7, 16, szName, 32);
