...
new const gszBlockModelSmallDefault[] = "models/blockmaker/bm_block_small_default.mdl";
new const gszBlockModelSmallPlatform[] = "models/blockmaker/bm_block_small_platform.mdl";
new const gszBlockModelSmallBhop[] = "models/blockmaker/bm_block_small_bhop.mdl";
new const gszBlockModelSmallDamage[] = "models/blockmaker/bm_block_small_damage.mdl";
new const gszBlockModelSmallHealer[] = "models/blockmaker/bm_block_small_healer.mdl";
new const gszBlockModelSmallInvincibility[] = "models/blockmaker/bm_block_small_invincibility.mdl";
new const gszBlockModelSmallStealth[] = "models/blockmaker/bm_block_small_stealth.mdl";
new const gszBlockModelSmallSpeedBoost[] = "models/blockmaker/bm_block_small_speedboost.mdl";
new const gszBlockModelSmallNoFallDamage[] = "models/blockmaker/bm_block_small_nofalldamage.mdl";
new const gszBlockModelSmallIce[] = "models/blockmaker/bm_block_small_ice.mdl";
new const gszBlockModelSmallDeath[] = "models/blockmaker/bm_block_small_death.mdl";
new const gszBlockModelSmallNuke[] = "models/blockmaker/bm_block_small_nuke.mdl";
new const gszBlockModelSmallCamouflage[] = "models/blockmaker/bm_block_small_camouflage.mdl";
new const gszBlockModelSmallLowGravity[] = "models/blockmaker/bm_block_small_lowgravity.mdl";
new const gszBlockModelSmallFire[] = "models/blockmaker/bm_block_small_fire.mdl";
new const gszBlockModelSmallRandom[] = "models/blockmaker/bm_block_small_random.mdl";
new const gszBlockModelSmallSlap[] = "models/blockmaker/bm_block_small_slap.mdl";
new const gszBlockModelSmallHoney[] = "models/blockmaker/bm_block_small_honey.mdl";
new const gszBlockModelSmallBarrierCT[] = "models/blockmaker/bm_block_small_barrier_ct.mdl";
new const gszBlockModelSmallBarrierT[] = "models/blockmaker/bm_block_small_barrier_t.mdl";
new const gszBlockModelSmallBootsOfSpeed[] = "models/blockmaker/bm_block_small_bootsofspeed.mdl";
new const gszBlockModelSmallGlass[] = "models/blockmaker/bm_block_small_glass.mdl";
new const gszBlockModelSmallBhopNoSlow[] = "models/blockmaker/bm_block_small_bhop_noslow.mdl";
new const gszBlockModelSmallAutoBhop[] = "models/blockmaker/bm_block_small_autobhop.mdl";

new const gszBlockModelLargeDefault[] = "models/blockmaker/bm_block_large_default.mdl";
new const gszBlockModelLargePlatform[] = "models/blockmaker/bm_block_large_platform.mdl";
new const gszBlockModelLargeBhop[] = "models/blockmaker/bm_block_large_bhop.mdl";
new const gszBlockModelLargeDamage[] = "models/blockmaker/bm_block_large_damage.mdl";
new const gszBlockModelLargeHealer[] = "models/blockmaker/bm_block_large_healer.mdl";
new const gszBlockModelLargeInvincibility[] = "models/blockmaker/bm_block_large_invincibility.mdl";
new const gszBlockModelLargeStealth[] = "models/blockmaker/bm_block_large_stealth.mdl";
new const gszBlockModelLargeSpeedBoost[] = "models/blockmaker/bm_block_large_speedboost.mdl";
new const gszBlockModelLargeNoFallDamage[] = "models/blockmaker/bm_block_large_nofalldamage.mdl";
new const gszBlockModelLargeIce[] = "models/blockmaker/bm_block_large_ice.mdl";
new const gszBlockModelLargeDeath[] = "models/blockmaker/bm_block_large_death.mdl";
new const gszBlockModelLargeNuke[] = "models/blockmaker/bm_block_large_nuke.mdl";
new const gszBlockModelLargeCamouflage[] = "models/blockmaker/bm_block_large_camouflage.mdl";
new const gszBlockModelLargeLowGravity[] = "models/blockmaker/bm_block_large_lowgravity.mdl";
new const gszBlockModelLargeFire[] = "models/blockmaker/bm_block_large_fire.mdl";
new const gszBlockModelLargeRandom[] = "models/blockmaker/bm_block_large_random.mdl";
new const gszBlockModelLargeSlap[] = "models/blockmaker/bm_block_large_slap.mdl";
new const gszBlockModelLargeHoney[] = "models/blockmaker/bm_block_large_honey.mdl";
new const gszBlockModelLargeBarrierCT[] = "models/blockmaker/bm_block_large_barrier_ct.mdl";
new const gszBlockModelLargeBarrierT[] = "models/blockmaker/bm_block_large_barrier_t.mdl";
new const gszBlockModelLargeBootsOfSpeed[] = "models/blockmaker/bm_block_large_bootsofspeed.mdl";
new const gszBlockModelLargeGlass[] = "models/blockmaker/bm_block_large_glass.mdl";
new const gszBlockModelLargeBhopNoSlow[] = "models/blockmaker/bm_block_large_bhop_noslow.mdl";
new const gszBlockModelLargeAutoBhop[] = "models/blockmaker/bm_block_large_autobhop.mdl";


/* Block sprites */
new const gszBlockSpriteFire[] = "sprites/blockmaker/bm_block_fire.spr";			//custom
new const gszBlockSpriteLargeFire[] = "sprites/blockmaker/bm_block_fire_large.spr";			//custom
new const gszBlockSpriteSmallFire[] = "sprites/blockmaker/bm_block_fire_small.spr";			//custom
new const gszBlockSpriteTrampoline[] = "sprites/blockmaker/bm_block_trampoline.spr";	//custom
new const gszBlockSpriteSmallTrampoline[] = "sprites/blockmaker/bm_block_trampoline_small.spr";	//custom
new const gszBlockSpriteLargeTrampoline[] = "sprites/blockmaker/bm_block_trampoline_large.spr";	//custom
...
new const DefaultRenderName[MAX_DEFAULT_RENDERS][32] = {
  "Normal", "Glowing Shell", "Bright Transparent", "Distorted", "Just Glowing Shell", "Annoying", "Big Glowing Shell", "Transparent"
};

new const DefaultRenderFx[MAX_DEFAULT_RENDERS] = {
  kRenderFxNone, kRenderFxGlowShell, kRenderFxNone, kRenderFxDistort, kRenderFxGlowShell, kRenderFxGlowShell, kRenderFxGlowShell, kRenderFxNone
};

new const DefaultRender[MAX_DEFAULT_RENDERS] = {
  kRenderNormal, kRenderNormal, kRenderTransAdd, kRenderTransAlpha, kRenderTransAlpha, kRenderTransAdd, kRenderNormal, kRenderTransTexture
};

new const Float:DefaultRenderAlpha[MAX_DEFAULT_RENDERS] = {
  0.0, 0.0, 100.0, 0.0, 1.0, 64.0, 255.0, 128.0
};

new const Float:DefaultRenderRGB[MAX_DEFAULT_RENDERS][3] = {
  {0.0, 0.0, 0.0}, {128.0, 128.0, 128.0}, {255.0, 255.0, 255.0}, {0.0, 0.0, 0.0}, {64.0, 64.0, 64.0}, {64.0, 64.0, 64.0}, {64.0, 64.0, 64.0}, {64.0, 64.0, 64.0}
};
...
new const Float:gBlockValues[gBlockMax][MAX_VALUES] = {
	...
	{-1.0, 500.0,  1000.0, 3000.0, 5000.0}, // speed boost
...
public plugin_init()
{
	...
	register_clcmd("bmsize", "cmdAdjustSize", BM_ADMIN_LEVEL, "Adjusts the size of the block");
	register_clcmd("bmvalue", "cmdValue", BM_ADMIN_LEVEL, "Adjusts the value for the block (-1 for default)");
	register_clcmd("bmnoclip", "cmdNoClip", BM_ADMIN_LEVEL, "Toggles noclip on/off");
...
public plugin_precache()
{
	...
	precache_model(gszBlockSpriteLargeFire);
	precache_model(gszBlockSpriteSmallFire);
	precache_model(gszBlockSpriteTrampoline);
	precache_model(gszBlockSpriteLargeTrampoline);
	precache_model(gszBlockSpriteSmallTrampoline);
...
createMenus()
{
	...
	add(gszBlockMenu, size, "\r6. %sAdjust Size^n");
	add(gszBlockMenu, size, "\r7. %sAdjust Value^n^n");
	add(gszBlockMenu, size, "\r8. %sRender Menu^n^n");
	add(gszBlockMenu, size, "\r9. \wOptions Menu^n^n");
	...
	add(gszRenderMenu, size, "\yRender Menu^n^n");
	add(gszRenderMenu, size, "\r1. %sDefault Renders^n");
	add(gszRenderMenu, size, "\r2. %sRender Fx Type^n");
	add(gszRenderMenu, size, "\r3. %sRender Type^n");
	add(gszRenderMenu, size, "\r4. %sAlpha^n");
	add(gszRenderMenu, size, "\r5. %sRed^n");
	add(gszRenderMenu, size, "\r6. %sGreen^n");
	add(gszRenderMenu, size, "\r7. %sBlue^n^n");
	add(gszRenderMenu, size, "\r0. \wBack");
	gKeysRenderMenu = B1 | B2 | B3 | B4 | B5 | B6 | B7 | B0;
	
	size = sizeof(gszDefaultRenderMenu);
	add(gszDefaultRenderMenu, size, "\yDefault Render Options^n^n");
	new i;
	new intStr[32];
	...
	add(gszDefaultRenderMenu, size, "^n\r0. \wBack");
...
public client_PreThink(id)
{
	...
	if ((is_user_connected(id)) )
	{
		...
		if (isBlock(ent) && (pev(id, pev_button) & IN_USE && !(pev(id, pev_oldbuttons) & IN_USE) ))
		{
			...
			if(!strcmp(Name, "")) {
				strcat(Name, "Uknown", 32);
			}
			
			set_hudmessage(255, 255, 255, gfTextX, gfTextY);//, gHudEffects, gfHudFxTime, gfHudHoldTime, gfHudFadeInTime, 2.0, gHudChannel);
			if (get_user_flags(id) & BM_ADMIN_LEVEL) {
				if(!strcmp(gszBlockValueNames[blockType], WORTHLESS_STR)) {
					strcat(valueLine, "", 32);
				} else {
					format(valueLine, 64, "%s: %s^n", gszBlockValueNames[blockType], fValueStr);
				}
				show_hudmessage(id, "%s^nScale: %f^n%sRenderFx: %s Render:%s^nRGB: (%f, %f, %f) Alpha: %f^nAuthor: %s", gszBlockNames[blockType], fScale, valueLine, gszRenderFxTypes[RenderFxType], gszRenderTypes[RenderType], RGB[0], RGB[1], RGB[2], Alpha, Name);
			} else { 
				show_hudmessage(id, "%s^n%s: %s^nAuthor: %s", gszBlockNames[blockType], gszBlockValueNames[blockType], fValueStr, Name);
			}
...
actionSpeedBoost(id, Float:fValue)
{
	...
	if (halflife_time() >= gfSpeedBoostTimeOut[id])
	{
		...
		pAim[2] = 0.0;					//make sure Z velocity is only as high as a jump
...
showBlockMenu(id)
{
	...
	//format the main menu
	format(szMenu, 256, gszBlockMenu, gszBlockNames[gSelectedBlockType[id]], col, col, col, col, col, col, col);
...
public handleBlockMenu(id, num)
{
	...
	if (num != N1 && num != N8 && num != N0 && num != N9)
	{
		//display menu again
		showBlockMenu(id);
	}
...
public handleRenderMenu(id, num) {
  switch (num) 
  {
    ...
    case N4: { adjustRenderValue(id, RENDER_TYPE_ALPHA); }
    case N5: { adjustRenderValue(id, RENDER_TYPE_RED); }
    case N6: { adjustRenderValue(id, RENDER_TYPE_GREEN); }
    case N7: { adjustRenderValue(id, RENDER_TYPE_BLUE); }
	...
	if (get_user_flags(id) & BM_ADMIN_LEVEL)
	{
		...
		for (new i = 1; i <= 32; ++i)
		{
			...
			if (is_user_connected(i))
			{
				...
				{
					client_print(i, print_chat, "%s'%s' saved %d block%s, %d teleporter%s! Total entites in map: %d", gszPrefix, szName, blockCount, (blockCount == 1 ? "" : "s"), teleCount, (teleCount == 1 ? "" : "s"), entity_count());
				}
			}
		}
...
loadBlocks(id)
{
	...
	if (bAccess)
	{
		...
		{
			//if a player is loading then first delete all the old blocks, teleports
			if (id > 0 && id <= 32)
			{
			...
			while (!feof(f))
			{
				...
				if (strlen(szType) > 0)
				{
					...
					switch (szType[0])
					{
						...
						case 'E': ent = createBlock(0, BM_INVINCIBILITY, vVec1, vVec2, fSizeMin, fSizeMax, fScale, fValue);
						case 'F': ent = createBlock(0, BM_STEALTH, vVec1, vVec2, fSizeMin, fSizeMax, fScale, fValue);
						...
						case 'I': ent = createBlock(0, BM_NOFALLDAMAGE, vVec1, vVec2, fSizeMin, fSizeMax, fScale, fValue);
						case 'J': ent = createBlock(0, BM_ICE, vVec1, vVec2, fSizeMin, fSizeMax, fScale, fValue);
			...
			if (id > 0 && id <= 32)
			{
				...
				for (new i = 1; i <= 32; ++i)
				{
					...
					if (is_user_connected(i))
					{
						if (get_user_flags(i) & BM_ADMIN_LEVEL)
						{
							client_print(i, print_chat, "%s'%s' loaded %d block%s, %d teleporter%s! Total entites in map: %d", gszPrefix, szName, blockCount, (blockCount == 1 ? "" : "s"), teleCount, (teleCount == 1 ? "" : "s"), entity_count());
						}
					}
				}
			}
