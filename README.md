...
# Mods
- Blockmaker (over 10 different BM main plugins)
- Deathrun (Extreme, Fun)
- Jailbreak
- Zombie
- Other (Plugins with Global Functionality)
...
# UJAC
Ultimate Jump Anti Cheat
- Written long time ago, but it is still effective anti cheat
