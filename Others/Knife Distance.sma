/*
	...
	Добра и хубава статистика за KNIFE сървъри, която показва от каква дистанция е бил убит някого.
	Стилът на съобщенията е подобен на UQ Jumpstats. Изкарва също подробна статистика за убийството с нож.
