/*
	...
	Прост плъгин, с който можете да зададете перманентно худ съобщение на екрана на играчите.
	Съобщеняита се променят от hud_messages, като на всеки ред се записва новот.
	Последното съобщение не трябва да бъде със запетая !
