/*
	...
	Visible / Invisible knife - С меню при първо влизане и запазване на избора след първият избор. 
	Има команда, с която може да се преминава от видим на невидим нож.
	Полезен плъгин за HNS сървъри.
	Плъгина работи само за ножа на Терористите !
