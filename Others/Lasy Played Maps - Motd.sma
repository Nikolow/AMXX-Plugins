/*
	...
	С командата /maps ви изкарва МОТД екран, в който се показват последните изиграни карти.
	На 16 ред можете да промените броя на последните запазвани карти, които ще излязат.
