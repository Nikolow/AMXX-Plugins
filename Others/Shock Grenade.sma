/*
	...
	Превръща дадена граната в Шокова такава (според настройката).
	Ефекта на шока е: Преобръщане на екрана, заметресение + fade на екрана.
	Има настройки, които са обяснени малко по-долу.
