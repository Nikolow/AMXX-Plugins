/*
	...
	Разширен JailBreak Shop, много по-различен от обикновеният.
	Може да се полазва като втори магазин, само трябва да се промени командата за достъп до менюто.
	Доста айтъми в магазина, както и доста настройки (по-долу).
