...
*	 	 	 	 	 	 	   *
***********==============Wersja 1.0==============***********
*        - Dodanie eDeath oraz dodawania xp, leveli	   *
*	 - Dodanie cvarow	 	 	 	   *
*	 	 	 	 	 	 	   *
***********==============Wersja 1.1==============***********
*	 - Dodanie 10 leveli	 	 	 	   *
*	 - Dodanie dodawania/zabierania xp	 	   *
*	 	 	 	 	 	 	   *
***********==============Wersja 1.2==============***********
*	 - Dodanie punktow	 	 	 	   *
*	 - Dodanie dodawania/zabierania punktow	 	   *
*	 	 	 	 	 	 	   *
***********==============Wersja 1.3==============***********
*	 - Dodanie menu pod komenda /xp	 	 	   *
*	 - Dodanie zycia za punkty	 	 	   *
*	 - Dodanie armora za punkty	 	 	   *
*	   	 	 	 	 	 	   *
***********==============Wersja 1.4==============***********
*	 - Dodanie head_splasha	 	 	 	   *
*	 - Poprawienie head_splasha	 	 	   *
*	   	 	 	 	 	  	   *
***********==============Wersja 1.5==============***********
*	 - Dodanie xp za zabicie head_splashem	 	   *
*	 - Dodanie uzyl1, uzyl2, uzyl3	 	 	   * 
*	   	 	 	 	 	 	   *
***********==============Wersja 1.6==============***********
*	 - Dodanie skilla niewidzialnosc	 	   *
*	 - Dodanie skilla kamuflaz	 	 	   *
*	 - Dodanie skilla gravitacja	 	 	   *
*	 	 	 	 	 	 	   *
************==============Wersja 1.7==============**********
*	 - Dodanie rang	 	 	 	 	   *
*	 - Dodanie broni 	 	 		   *
...
#define PLUGIN "emu eXperience Mod"
#define VERSION "1.9"
#define AUTHOR "emu"
...
public plugin_init() { 
	...
	gCvar_Kill    = register_cvar("emu_kill", "5"); 
	gCvar_HS    = register_cvar("emu_hs", "10"); 
	...
	//Komendy
	register_clcmd("say /dodaj", "menu_xp");  		// menu
	register_clcmd("say_team /dodaj", "menu_xp"); 		// menu
	register_clcmd("say /gracze", "gracze_info");  		// info
	register_clcmd("say_team /gracze", "gracze_info");  	// info
	register_clcmd("say /u1", "skill_1");  			// skill 1
	register_clcmd("say_team /u1", "skill_1");  		// skill 1
	register_clcmd("say /u2", "skill_2");  			// skill 2
	register_clcmd("say_team /u2", "skill_2");  		// skill 2
	register_clcmd("say /u3", "skill_3");  			// skill 3
	register_clcmd("say_team /u3", "skill_3");  		// skill 3
	register_clcmd("say /pomoc", "pomoc_noob");  		// skill 3
	register_clcmd("say_team /pomoc", "pomoc_noob");  	// skill 3
	...
	register_clcmd("say /dodatki", "dodatki_menu");  		// menu
	register_clcmd("say_team /dodatki", "dodatki_menu"); 	// menu
...
public plugin_precache() {
	precache_model("models/player/emu_vip_ct/emu_vip_ct.mdl");
	precache_model("models/player/emu_vip_tt/emu_vip_tt.mdl");
...
public dodatki_menu_wybierz(id, dodatki_menu  , item)
{
	...
	{ 
		case 1 : {
			show_motd (id,"dodatki_1.txt","Inforamcje o dodatkach 1");
		}
		case 2 : {
			show_motd (id,"dodatki_2.txt","Inforamcje o dodatkach 2")
		}
		case 3 : {
			show_motd (id,"dodatki_3.txt","Inforamcje o dodatkach 3")
		}
...
{
	new msg0[128]
	format(msg0,127,"\w[\remu eXperience Mod\w]\y Menu");
...
public xp_menu_wybierz(id, xp_menu  , item)
{
	...
	{ 
		...
		case 5 : {
			show_motd (id,"vipy.txt","Vipy")
		}
		case 6 : {
			client_cmd(id,"bind ^"z^" ^"say /u1^"");
			client_cmd(id,"bind ^"x^" ^"say /u2^"");
			client_cmd(id,"bind ^"c^" ^"say /u3^"");
			ColorChat(id, GREEN, "******** Skill 1 pod Z, Skill 2 pod X, Skill 3 pod C." );
		}
		case 7 : {
			ColorChat(id, GREEN, "******** Zglos sie do admina, on poda Ci wiecej informacji." );
		}
		case 8: {
...
public reset_napewno(id)
{
	...
	new msg1[128]
	format(msg1,127,"\wTak \d(Stracisz wszystko oprocz levela i expa)")
...
public reset_wybierz(id, menu_reset , item)
{
	...
	{ 
		case 1 : {
			reset_punkty(id);
			ColorChat(id, GREEN, "******** Reset zakonczony sukcesem!");
			ColorChat(id, GREEN, "******** Masz teraz do wykorzystania %d punktow.", PlayerLevel[id]);
		}
		case 2 : {
			//reset_punkty(id);
			//ColorChat(id, GREEN, "******** Dodanie punkta do Zycia zakonczone sukcesem!");
		}
...
public reklama(id) {
	ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Na serverze jest^x03 emu eXperience Mod^x04 (eXM) %s^x01 by^x03 emu^x01.",VERSION);
}
public pomoc_noob(id) {
	if (is_user_connected(id) )
	{
		...
		ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Witaj^x03 %s^x01, na serverze jest^x03 emu eXperience Mod^x04 (EXP) %s^x01 by^x03 emu^x01.", name,VERSION);
		ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Komendy: ^x03 /xp^x01, ^x03 /gracze^x01, ^x03 /pomoc^x01, ^x03 /menuxp^x01." );
	}
}
...
public eDeath() { 
	...
	if(get_user_team(attacker) != get_user_team(victim) && attacker != 0) {
		...
		if (get_user_flags(attacker) & ADMIN_RESERVATION) {
			if(PlayerXP[attacker] < PlayerXP[victim]){
				if(headshot) {
					...
					ColorChat(attacker, GREEN, "[emu eXperience Mod]^x01 Dostales^03 20^x01 expa za zabicie gracza z wyzszym levelem oraz HeadShoot'a,^03 5^x01 expa za VIP'a.");
					//UpdateHUD(attacker);
					SaveData(attacker); 
				}
				else 
				{
					...
					ColorChat(attacker, GREEN, "[emu eXperience Mod]^x01 Dostales^03 15^x01 expa za zabicie gracza z wyzszym levelem,^03 5^x01 expa za VIP'a.");
					//UpdateHUD(attacker);
					SaveData(attacker); 
				}
			}
			else
			{
				if(headshot) {
					PlayerXP[attacker] += get_pcvar_num(gCvar_HS); 
					PlayerXP[attacker] += 5; 
					ColorChat(attacker, GREEN, "[emu eXperience Mod]^x01 Dostales^03 10^x01 expa za HeadShoot'a,^03 5^x01 expa za VIP'a.");
					//UpdateHUD(attacker);
					SaveData(attacker); 
				}
				else 
				{
					...
					PlayerXP[attacker] += 5; 
					//client_print(attacker, print_chat, "[XP] Dostales 20 expa za zabicie gracza.
					ColorChat(attacker, GREEN, "[emu eXperience Mod]^x01 Dostales^03 5^x01 expa za zabicie gracza,^03 5^x01 expa za VIP'a.");
					//UpdateHUD(attacker);
					SaveData(attacker); 
				}
			}
		...
		else 
		{
			if(PlayerXP[attacker] < PlayerXP[victim]){
				if(headshot) {
					PlayerXP[attacker] += get_pcvar_num(gCvar_HS); 
					PlayerXP[attacker] += 10;
					ColorChat(attacker, GREEN, "[emu eXperience Mod]^x01 Dostales^03 20^x01 expa za zabicie gracza z wyzszym levelem oraz za HeadShoot'a.");
					//UpdateHUD(attacker);
					SaveData(attacker); 
				}
				else 
				{
					...
					PlayerXP[attacker] += 10;
					//client_print(attacker, print_chat, "[XP] Dostales 20 expa za zabicie gracza.
					ColorChat(attacker, GREEN, "[emu eXperience Mod]^x01 Dostales^03 15^x01 expa za zabicie gracza z wyzszym levelem.");
					//UpdateHUD(attacker);
					SaveData(attacker); 
				}
			}
			else 
			{
				if(headshot) {
					PlayerXP[attacker] += get_pcvar_num(gCvar_HS); 
					ColorChat(attacker, GREEN, "[emu eXperience Mod]^x01 Dostales^03 10^x01 expa za HeadShoot'a.");
					//UpdateHUD(attacker);
					SaveData(attacker); 
				}
				else 
		...
		while(PlayerXP[attacker] >= LEVELS[PlayerLevel[attacker]]) { 
			...
			ColorChat(attacker, GREEN, "[emu eXperience Mod]^x01 Gratulacje! Wbiles^x03 %i^x01 level, wpisz^x03 /dodaj^x01 aby wykorzystac punkt.", PlayerLevel[attacker + 1]);
...
public skill_1(id) {
	if(punktysk1[id] <= 0) {
		...
		ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Musisz miec dodane^x03 2^x01 punkty!");
	}
	else if(uzyl[id] == true) {
		ColorChat(id, GREEN, "[emu eXperience Mod]^x03 Skill^x01 dostepny raz na runde!");
	}
	else
	{
		set_user_rendering(id, kRenderFxGlowShell, 0, 0, 0, kRenderTransColor, 0);
		set_task(6.0, "skill_1_off",id,"",0,"a", 1);
		ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Jestes niewidzialny przez 6 sekund!");
		uzyl[id] = true
	}
}
...
public skill_1_off(id) {
	...
	ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Uwazaj, wygladasz juz normalnie!");
}
...
public skill_2(id) {
	...
	else
	{
		if (get_user_team(id) == 1) // 1 - terro
		{
			...
			ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Wygladasz jak CT przez 15 sekund!");
			uzyl[id] = true
		}
		else
		{
			...
			set_task(15.0, "skill_2_off",id,"",0,"a", 1);
			ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Wygladasz jak TT przez 15 sekund!!");
			uzyl[id] = true
		}
	}
}
...
public skill_3(id) {
	...
	else
	{
		...
		ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Masz 400 grawitacji przez 5 sekund!");
		uzyl[id] = true
	}
}
...
public skill_3_off(id) {
	...
	ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Uwazaj, masz juz normalna grawitacje!");
}
	...
	for (new id=0; id < 32; id++) {
		...
		if (is_user_alive(id))
		{
			if(PlayerLevel[ id ] >= 15) {
				...
				show_hudmessage(id, "Poziom: Max / 15^nExp: Max / 18100 (+0)^nRanga: Bog EasyBlock");
			}
			else 
			{
				set_hudmessage(50,135,180,0.5,0.04,0,1.0, 12.0)
				show_hudmessage(id, "Poziom: %i / 15^nExp: %d / %d (+%d)^nRanga: %s",PlayerLevel[id],PlayerXP[id],LEVELS[PlayerLevel[id]], LEVELS[PlayerLevel[id]] - PlayerXP[id], rank[id]);
			}
...
{
	new msg0[128]
	format(msg0,127,"\w[\remu eXperience Mod\w]\y Strona\r 1\w/\r2^n\w[\yPosiadasz punktow:\r %d\w]",punkty[id])
	new menu_exp = menu_create(msg0, "exp_wybierz")
	new msg1[128]
	format(msg1,127,"\wZycie \r[\w%d\y/\w5\r] \d(od 2 lvl)",punktyhp[id])
	menu_additem(menu_exp , msg1, "1", 0)
	new msg2[128]
	format(msg2,127,"\wArmor \r[\w%d\y/\w5\r]",punktyarm[id])
	menu_additem(menu_exp , msg2, "2", 0)
	new msg3[128]
	format(msg3,127,"\wRespawn \r[\w%d\y/\w1\r] \d(od 10 lvl)",punktyrespawn[id])
	menu_additem(menu_exp , msg3, "3", 0)
	new msg4[128]
	format(msg4,127,"\wNiewidzialnosc \r[\w%d\y/\w1\r] \d(od 8 lvl)",punktysk1[id])
	menu_additem(menu_exp , msg4, "4", 0)
	new msg5[128]
	format(msg5,127,"\wKamuflaz \r[\w%d\y/\w1\r] \d(od 5 lvl)",punktysk2[id])
	menu_additem(menu_exp , msg5, "5", 0)
	new msg6[128]
	format(msg6,127,"\wGrawitacja \r[\w%d\y/\w1\r] \d(od 15 lvl)",punktysk3[id])
	menu_additem(menu_exp , msg6, "6", 0)
	new msg7[128]
	format(msg7,127,"\wBronie \r[\w%d\y/\w2\r]",bronie[id])
	menu_additem(menu_exp , msg7, "7", 0)
	new msg8[128]
	format(msg8,127,"\wWzmocnienie \r[\w%d\y/\w10\r]^n",punktywzmoc[id])
	menu_additem(menu_exp , msg8, "8", 0)
	new msg9[128]
	format(msg9,127,"\wDalej\y (na strone 2)")
...
{
	new msg0[128]
	format(msg0,127,"\w[\remu eXperience Mod\w]\y Strona\r 2\w/\r2^n\w[\yPosiadasz punktow:\r %d\w]",punkty[id])
	new menu_exp_2 = menu_create(msg0, "exp_wybierz_2")
	new msg1[128]
	format(msg1,127,"\wCiche Chodzenie \r[\w%d\y/\w1\r]",punktychodzenie[id])
	menu_additem(menu_exp_2 , msg1, "1", 0)
	new msg2[128]
	format(msg2,127,"\wGranaty \r[\w%d\y/\w2\r]",punktygranat[id])
	menu_additem(menu_exp_2 , msg2, "2", 0)
	new msg3[128]
	format(msg3,127,"\wPistolety \r[\w%d\y/\w5\r] \d(od 15 lvl)",punktypistolety[id])
	menu_additem(menu_exp_2 , msg3, "3", 0)
	new msg4[128]
	format(msg4,127,"\wKarabiny \r[\w%d\y/\w5\r] \d(od 15 lvl)",punktykarabiny[id])
	menu_additem(menu_exp_2 , msg4, "4", 0)
	new msg5[128]
	format(msg5,127,"\wZestaw \r[\w%d\y/\w5\r] \d(od 15 lvl)^n^n^n^n",punktyzestaw[id])
	menu_additem(menu_exp_2 , msg5, "5", 0)
	new msg9[128]
	format(msg9,127,"\wCofnij\y (na strone 1)")
...
public exp_wybierz(id, menu_exp , item)
{
	...
	{ 
		case 1 : { 
			if(PlayerLevel[id] <= 1) {
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz^x03 2^x01 levela!");
			}
			else if(punkty[id] == 0) {
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz wystarczajacej ilosci punktow!");
			}
			else 
			{
				if(punktyhp[id] >= 5) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 3^x01!", punktyhp[id]);
				}
				else 
				{
					punkty[id] -= 1;
		...
		case 2 :  { 
			...
			{
				if(punktyarm[id] >= 5) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 3^x01!", punktyarm[id]);
				}
				else 
				{
					punkty[id] -= 1;
					punktyarm[id] += 1;
					ColorChat(id, GREEN, "******** Dodanie punkta do Armora zakonczone sukcesem!");
				}
			}
			menu_destroy(menu_exp); 
			menu_xp(id); 
		...
		case 3 :  { 
			if(PlayerLevel[id] <= 9) {
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz^x03 10^x01 levela!");
			}
			else if(punkty[id]<= 0) {
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz wystarczajacej ilosci punktow!");
			}
			else 
			{
				if(punktyrespawn[id] >= 1) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 1^x01!", punktyrespawn[id]);
				}
				else 
				{
					punkty[id] -= 1;
					punktyrespawn[id] += 1;
					ColorChat(id, GREEN, "******** Dodanie punkta do Respawna zakonczone sukcesem!");
				}
			}
			menu_destroy(menu_exp); 
			menu_xp(id); 
		...
		case 4 :  { 
			if(PlayerLevel[id] <= 7) {
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz^x03 8^x01 levela!");
			}
			else if(punkty[id] <= 1) { // else if
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz wystarczajacej ilosci punktow!");
			}
			else if(skille[id] >= 2) {
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Mozesz miec maksymalnie^x03 2^x01 skille!");
			}
			else 
			{
				if(punktysk1[id] >= 1) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 1^x01!", punktysk1[id]);
				}
				else 
				{
					punkty[id] -= 2;
					punktysk1[id] += 1;
					skille[id] += 1;
					ColorChat(id, GREEN, "******** Dodanie punkta do skilla Niewidzialnosc zakonczone sukcesem!");
				}
			}
			menu_destroy(menu_exp); 
			menu_xp(id);
		...
		case 5 :  { 
			if(PlayerLevel[id] <= 4) {
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz^x03 5^x01 levela!");
			}
			else if(punkty[id] <= 1) { // else if
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz wystarczajacej ilosci punktow!");
			}
			...
			{
				if(punktysk2[id] >= 1) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 1^x01!", punktysk2[id]);
				}
				else 
				{
					punkty[id] -= 2;
					punktysk2[id] += 1;
					skille[id] += 1;
					ColorChat(id, GREEN, "******** Dodanie punkta do skilla Kammuflaz zakonczone sukcesem!");
				}
			}
			menu_destroy(menu_exp); 
			menu_xp(id); 
		...
		case 6 :  { 
			if(PlayerLevel[id] <= 14) {
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz^x03 15^x01 levela!");
			}
			else if(punkty[id] <= 1) { // else if
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz wystarczajacej ilosci punktow!");
			}
			...
			{
				if(punktysk3[id] >= 1) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 1^x01!", punktysk3[id]);
				}
				else 
				{
					punkty[id] -= 2;
					punktysk3[id] += 1;
					skille[id] += 1;
					ColorChat(id, GREEN, "******** Dodanie punkta do skilla Gravitacja zakonczone sukcesem!");
				}
			}
			menu_destroy(menu_exp);
			menu_xp(id);
		...
		case 7: { 
			...
			{
				if(bronie[id] >= 2) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 2^x01!", bronie[id]);
				}
				else 
				{
					punkty[id] -= 1;
					bronie[id] += 1;
					ColorChat(id, GREEN, "******** Dodanie punkta do Broni zakonczone sukcesem!");
				}
			}
			menu_destroy(menu_exp); 
			menu_xp(id); 
		...
		case 8: { 
			...
			else 
			{
				if(punktywzmoc[id] >= 10) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 5^x01!", punktywzmoc[id]);
				}
				else 
				{
					punkty[id] -= 1;
					punktywzmoc[id] += 1;
					ColorChat(id, GREEN, "******** Dodanie punkta do Wzmocnienia zakonczone sukcesem!");
				}
			}
			menu_destroy(menu_exp); 
			menu_xp(id); 
...
public exp_wybierz_2(id, menu_exp_2 , item)
{
	...
	{ 
		case 1: { 
			...
			else 
			{
				if(punktychodzenie[id] >= 1) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 1^x01!", punktychodzenie[id]);
				}
				else 
				{
					punkty[id] -= 1;
					punktychodzenie[id] += 1;
					ColorChat(id, GREEN, "******** Dodanie punkta do Cichego Chodzenia zakonczone sukcesem!");
				}
			}
		...
		case 2: { 
			...
			else 
			{
				if(punktygranat[id] >= 2) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 2^x01!", punktygranat[id]);
				}
				else 
				{
					punkty[id] -= 1;
					punktygranat[id] += 1;
					ColorChat(id, GREEN, "******** Dodanie punkta do Granatow zakonczone sukcesem!");
				}
			}
			menu_destroy(menu_exp_2); 
			menu_xp_2(id); 
		...
		case 3: { 
			if(PlayerLevel[id] <= 14) {
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz^x03 20^x01 levela!");
			}
			else if(punkty[id] == 0) {
				ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Nie masz wystarczajacej ilosci punktow!");
			}
			else 
			{
				if(punktypistolety[id] >= 5) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 5^x01!", punktypistolety[id]);
				}
				else 
				{
					punkty[id] -= 1;
					punktypistolety[id] += 1;
					ColorChat(id, GREEN, "******** Dodanie punkta do Pistoletow zakonczone sukcesem!");
				}
			}
			menu_destroy(menu_exp_2); 
			menu_xp_2(id); 
		...
		case 4: { 
			...
			else 
			{
				if(punktykarabiny[id] >= 5) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 5^x01!", punktykarabiny[id]);
				}
				else 
				{
					punkty[id] -= 1;
		...
		case 5: { 
			...
			else 
			{
				if(punktyzestaw[id] >= 5) {
					ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Przepraszam, masz juz^x03 %i^x04 /^x03 5^x01!", punktyzestaw[id]);
				}
				else 
				{
					punkty[id] -= 1;
	...
	if(los <= 7 * bronie[id]){ // 7 * bronie[id]
		if(punktypistolety[id] >= 1) {
			...
			switch(bronie_los)  {
				case 1: {
					...
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Glocka z 4 nabojami!", 7 * bronie[id]);
				}
				case 2: {
					give_item( id, "weapon_fiveseven" );
					cs_set_user_bpammo(id, CSW_FIVESEVEN, 0);
					cs_set_weapon_ammo( find_ent_by_owner( 3, "weapon_fiveseven", id ), 3); 
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales FiveSevena z3 nabojami!", 7 * bronie[id]);
				}
			}
		}
		else 
		{
			...
			switch(bronie_los)  {
				case 1: {
					...
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Pukawke z 1 nabojem!", 7 * bronie[id]);
				}
				case 2: {
					give_item( id, "weapon_m3" );
					cs_set_user_bpammo(id, CSW_M3, 0);
					cs_set_weapon_ammo( find_ent_by_owner( 1, "weapon_m3", id ), 1); 
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Shoota z 1 nabojem!", 7 * bronie[id]);
				}
				case 3: {
					give_item( id, "weapon_tmp" );
					cs_set_user_bpammo(id, CSW_TMP, 0);
					cs_set_weapon_ammo( find_ent_by_owner( 2, "weapon_tmp", id ), 2); 
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Wiertare z 2 nabojami!", 7 * bronie[id]);
		...
		switch(bronie_los)  {
			case 1: {
				...
				ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Uzi z 1 nabojem!", 10 * bronie[id]);
			}
			case 2: {
				give_item( id, "weapon_mp5navy" );
				cs_set_user_bpammo(id, CSW_MP5NAVY, 0);
				cs_set_weapon_ammo( find_ent_by_owner( 1, "weapon_mp5navy", id ), 1); 
				ColorChat(id, GREEN, "[%d '/.]^x01 Dostales MP5Navy z 1 nabojem!", 10 * bronie[id]);
			}
			case 3: {
				give_item( id, "weapon_glock18" );
				cs_set_user_bpammo(id, CSW_GLOCK18, 0);
				cs_set_weapon_ammo( find_ent_by_owner( 1, "weapon_glock18", id ), 1); 
				ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Glocka z 1 nabojem!", 10 * bronie[id]);
			...
			case 4: {
				...
				ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Usp z 1 nabojem!", 10 * bronie[id]);
		...
		switch(bronie_los)  {
			case 1: {
				...
				ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Shoota z 1 nabojem!", 8 * bronie[id]);
			}
			case 2: {
				give_item( id, "weapon_fiveseven" );
				cs_set_user_bpammo(id, CSW_FIVESEVEN, 0);
				cs_set_weapon_ammo( find_ent_by_owner( 1, "weapon_fiveseven", id ), 1); 
				ColorChat(id, GREEN, "[%d '/.]^x01 Dostales FiveSeven z 1 nabojem!", 8 * bronie[id]);
			}
			case 3: {
				give_item( id, "weapon_elite" );
				cs_set_user_bpammo(id, CSW_ELITE, 0);
				cs_set_weapon_ammo( find_ent_by_owner( 1, "weapon_elite", id ), 1); 
				ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Elite z 1 nabojem!", 8 * bronie[id]);
		...
		if(punktyzestaw[id] >= 1){
			...
			switch(bronie_los)  {
				case 1: {
					...
					cs_set_user_bpammo(id, CSW_GLOCK18, 0);
					cs_set_weapon_ammo( find_ent_by_owner( 1, "weapon_glock18", id ), 1); 
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Zestaw z 1 nabojem!", 3 * bronie[id]);
				}
				case 2: {
			...
			switch(bronie_los)  {
				case 1: {
					...
					cs_set_user_bpammo(id, CSW_M4A1, 0);
					cs_set_weapon_ammo( find_ent_by_owner( 1, "weapon_m4a1", id ), 1);  
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales M4a1 z 1 nabojem!", 3 * bronie[id]);
				}
				case 2: {
					give_item( id, "weapon_ak47" );
					cs_set_user_bpammo(id, CSW_AK47, 0);
					cs_set_weapon_ammo( find_ent_by_owner( 1, "weapon_ak47", id ), 1);  
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Ak-47 z 1 nabojem!", 3 * bronie[id]);
				}
		...
		else 
		{
			...
			switch(bronie_los)  {
				case 1: {
					...
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Awp z 1 nabojem!", 3 * bronie[id]);
				}
				case 2: {
					give_item( id, "weapon_deagle" );
					cs_set_user_bpammo(id, CSW_DEAGLE, 0);
					cs_set_weapon_ammo( find_ent_by_owner( 1, "weapon_deagle", id ), 1); 
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Deagle z 1 nabojem!", 3 * bronie[id]);
				}
				case 3: {
					give_item( id, "weapon_tmp" );
					cs_set_user_bpammo(id, CSW_TMP, 0);
					cs_set_weapon_ammo( find_ent_by_owner( 2, "weapon_tmp", id ), 2); 
					ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Wiertare z 2 nabojami!", 3 * bronie[id]);
		...
		ColorChat(id, GREEN, "******** Przykro mi, nic nie wylosowales.");
	}
}
public weapon_granaty(id) {
	...
	if(los <= 50 * punktygranat[id]){
		if (get_user_team(id) == 1) // 1 - terro
		{
			...
			give_item(id, "weapon_flashbang"); 
			ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Zestaw Granatow!", 50 * punktygranat[id]);
		}
		else
		{
			//give_item(id, "weapon_smokegrenade"); 
			...
			//give_item(id, "weapon_flashbang"); 
			//give_item(id, "weapon_flashbang"); 
			ColorChat(id, GREEN, "[%d '/.]^x01 Dostales Granata Wybuchowego!", 50 * punktygranat[id]);
		}
		
	}
	
	else { // 49 procent ze nic nie wypadnie
		//ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Pech.. nic nie wylosowales.");
	}
}
public EventRoundEnd(id) {
	for (new id=0; id < 32; id++) {
		...
		if(is_user_alive(id) && get_user_team(id) == 1) { // && get_user_team == 1
			ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Dostales^x03 5^x01 expa za przezycie rundy!");
			PlayerXP[id] += 5;
		}
	}
}
...
public cmd_give_exp( id, level,cid ) { 
	...
	client_print( player, print_chat, "[emu eXperience Mod] Zyskales %i expa (Razem: %d)", expnum, PlayerXP[player] ); 
	SaveData( id ); 
...
public cmd_take_exp( id, level,cid ) { 
	...
	client_print( player, print_chat, "[emu eXperience Mod] Straciles %i expa (Razem: %d)", expnum, PlayerXP[player] ); 
	SaveData( id ); 
...
public cmd_give_ptk( id, level,cid ) { 
	...
	client_print( player, print_chat, "[emu eXperience Mod] Zyskales %i punktow (Razem: %i)", expnum, punkty[player] ); 
	SaveData( id ); 
...
public cmd_take_ptk( id, level,cid ) { 
	...
	client_print( player, print_chat, "[emu eXperience Mod] Straciles %i punktow (Razem: %i)", expnum, punkty[player] ); 
	SaveData( id ); 
...
public respawn(id) {
	...
	switch(losik)  {
		...
		case 1: {
			...
			ColorChat(id, GREEN, "[emu eXperience Mod]^x01 Zostales zrespiony");
			EventRoundStart(id);
		}
		case 2:  {
...
public damage_player(pwned, pwnzor, Float:damage) // Damages or kills a player. Home made HAX
{
	...
	else
	{
		...
		//PlayerXP[pwnzor] += 7;
		//ColorChat(pwnzor, GREEN, "[emu eXperience Mod]^x01 Dostales^03 7^x01 expa za zabicie gracza head_splashem.");
		
		//PlayerXP[victim] -= 7;
		//ColorChat(attacker, GREEN, "[EXP MOD]^x01 Straciles^03 7^x01 expa za zabicie gracza head_splashem.");
		...
		if (get_user_flags(pwnzor) && ADMIN_RESERVATION) {
			if(PlayerXP[pwnzor] < PlayerXP[pwned]){
				...
				PlayerXP[pwnzor] += 10;
				PlayerXP[pwnzor] += 5;
				ColorChat(pwnzor, GREEN, "[emu eXperience Mod]^x01 Dostales^03 17^x01 expa za zabicie gracza head_splashem oraz z wyzszym levelem,^03 5^x01 expa za VIP'a.");
				//UpdateHUD(attacker);
			}
			else 
			{
				...
				PlayerXP[pwnzor] += 5;
				//client_print(attacker, print_chat, "[XP] Dostales 20 expa za zabicie gracza.
				ColorChat(pwnzor, GREEN, "[emu eXperience Mod]^x01 Dostales^03 7^x01 expa za zabicie gracza head_splashem,^03 5^x01 expa za VIP'a.");
				//UpdateHUD(attacker);
			}
		}
		...
		else 
		{
			if(PlayerLevel[pwnzor] < PlayerLevel[pwned]){
				...
				PlayerXP[pwnzor] += 10;
				//client_print(attacker, print_chat, "[XP] Dostales 20 expa za zabicie gracza.
				ColorChat(pwnzor, GREEN, "[emu eXperience Mod]^x01 Dostales^03 17^x01 expa za zabicie gracza head_splashem oraz z wyzszym levelem.");
				//UpdateHUD(attacker);
			}
			else 
			{
		...
		while(PlayerXP[pwnzor] >= LEVELS[PlayerLevel[pwnzor]]) { 
			//client_print(attacker, print_chat, "[XP] Gratulacje! Wbiles %i level, napisz /xp aby wykorzystac punkt.", PlayerLevel[attacker]); 
			ColorChat(pwnzor, GREEN, "[EXP MOD]^x01 Gratulacje! Wbiles^x03 %i^x01 level, wpisz^x03 /dodaj^x01 aby wykorzystac punkt.", PlayerLevel[pwnzor + 1]);
...
if(victim != attacker)
{
	...
	if( read_data(3) )
	{
		// headshot 
		PlayerXP[attacker] += get_pcvar_num(gCvar_HS); 
		ColorChat(attacker, GREEN, "[EXP MOD]^x01 Dostales^03 20^x01 expa za zabicie gracza w glowe.");
	}
	
	ColorChat(attacker, GREEN, "[EXP MOD]^x01 Dostales^03 20^x01 expa za zabicie gracza.");
	
	while(PlayerXP[attacker] >= LEVELS[PlayerLevel[attacker]]) { 
		//client_print(attacker, print_chat, "[XP] Gratulacje! Wbiles %i level, napisz /xp aby wykorzystac punkt.", PlayerLevel[attacker]); 
		ColorChat(attacker, GREEN, "[EXP MOD]^x01 Gratulacje! Wbiles^x03 %i^x01 level, wpisz^x03 /xp^x01 aby wykorzystac punkt.", PlayerLevel[attacker]);
		PlayerLevel[attacker] += 1; 
		punkty[attacker] += 1;
	} 
